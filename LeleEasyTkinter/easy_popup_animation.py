...
from LeleEasyTkinter.easy_fade_animation import fade_out
...
EasyAutoWindow(root, window_title="动画演示", window_width_value=1, window_height_value=1, adjust_x=False,
               adjust_y=False, window_x_value=700, window_y_value=500)

EasyLabel(root, text="动画演示", expand=True, font_size=100)

animate_resize_window(root, 1000, 600, 50, "ordinary", False)
